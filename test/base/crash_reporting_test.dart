...
import 'package:pedantic/pedantic.dart' hide unawaited;
...
//      Cache.disableLocking();
    ...
    testUsingContext('should send crash reports', () async {
      ...
      tools.crashReportSender=CrashReportSender(MockCrashReportSender(requestInfo), tools.kCrashServerHost, tools.kCrashEndpointPath, tools.kProductId);
    ...
    testUsingContext('should not send a crash report if on a user-branch', () async {
      ...
      tools.crashReportSender=CrashReportSender(MockClient((Request request) async {
