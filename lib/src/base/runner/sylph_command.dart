...
//import 'package:tool_base/src/base/user_messages.dart';
import 'package:tool_base/src/base/utils.dart';
...
abstract class FastFlutterCommand extends SylphCommand {
  @override
  Future<void> run() {
    return context.run<void>(
      name: 'command',
